# Data Model: ROS2 Robotic Nervous System Module
...
This document defines the conceptual data model for the ROS2 educational module. Since this is primarily a documentation project, the "data model" refers to the organizational structure and content entities that will be used in the Docusaurus implementation.

## Content Entities

### Chapter
- **name**: String (e.g., "ROS 2 Core Concepts", "Python Agents with rclpy", "Humanoid Description with URDF")
...
### Section
- **title**: String (e.g., "ROS 2 Purpose", "Nodes, Topics, Services")
